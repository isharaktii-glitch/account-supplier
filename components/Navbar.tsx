  ...
  return (
    <nav className="w-full bg-slate-950/80 backdrop-blur-md border-b border-cyan-500/20 sticky top-0 z-50 px-6 py-4 flex justify-between items-center shadow-[0_4px_20px_rgba(0,240,255,0.15)]">
      ...
      <div className="flex space-x-6 text-sm font-medium text-slate-300">
        <Link href="/guidelines" className="hover:text-cyan-400 transition-all hover:drop-shadow-[0_0_8px_rgba(0,240,255,0.8)]">Guidelines</Link>
        <Link href="/dashboard/worker" className="hover:text-cyan-400 transition-all">Worker Portal</Link>
        <Link href="/dashboard/buyer" className="hover:text-cyan-400 transition-all">Buyer Portal</Link>
